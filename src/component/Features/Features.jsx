        ...
        <div className="row">
          <div className="col-xl-5 col-lg-5 col-md-5 col-12">
            <div className="images">
              <div>
                <div className="div1" data-aos="fade-up" data-aos-delay="300" data-aos-offset="200"></div>
                <div className="dotted bounce"></div>
              </div>
              <div>
                <div className="div2" data-aos="fade-up" data-aos-delay="500" data-aos-offset="200"></div>
                ...
                <div className="overlay" data-aos="fade-up" data-aos-delay="700" data-aos-offset="200"></div>
              </div>
            </div>
          </div>

          <div className="col-xl-7 col-lg-7 col-md-7 col-12">
            <h4 className="mb-4 main-color title" data-aos="fade-up" data-aos-offset="100"><img src="/list.gif" alt="--"/> {t("features.platformFeatures")}</h4>
            ...
            <ul className="list-unstyled ul-list p-0 my-5">
              <li data-aos="fade-up">
                ...
                <span className="gray-color text-sm mx-2">----------</span>
              </li>
              <li data-aos="fade-up">
                <i className="bi bi-check-circle-fill main-color"></i>
                <span className="gray-color text-sm mx-2">----------</span>
