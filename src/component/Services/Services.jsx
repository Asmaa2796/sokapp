  ...
  return (
    <div className="services py-5">
      <div className="container">
        <h4 className="mb-3 main-color text-center title" data-aos="fade-up"><img src="/shopping-list.gif" alt="--"/> {t("services.title")}</h4>
        <p className="mb-4 gray-color text-center" data-aos="fade-up" data-aos-delay="300" data-aos-offset="100">
