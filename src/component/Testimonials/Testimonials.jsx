  ...
  return (
    <div className="testimonials py-5">
      <div className="container">
        <h4 className="mb-4 main-color text-center title" data-aos="fade-up" data-aos-offset="100">
          <img src="/good-review.gif" alt="--"/> {t("testimonials.sectionTitle")}
        </h4>
        <p className="text-center gray-color" data-aos="fade-up" data-aos-delay="300" data-aos-offset="100">
